...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        AvaliacaoComida avaliacaoComida = new AvaliacaoComida(4.5f);
        ...
        AvaliacaoAtendimento avaliacaoAtendimento = new AvaliacaoAtendimento(5.0f);
        ...
        AvaliacaoAmbiente avaliacaoAmbiente = new AvaliacaoAmbiente(4.0f);
        ...
        AvaliacaoLocalizacao avaliacaoLocalizacao = new AvaliacaoLocalizacao(4.8f);
        ...
        classificacaoFinal.setDataClassificacao(new Date(Calendar.getInstance().getTimeInMillis()));
